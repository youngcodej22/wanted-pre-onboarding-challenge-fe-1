...
const GlobalStyle = css`
  @import url("https://fonts.googleapis.com/css2?family=Nanum+Gothic+Coding:wght@400;700&family=Titillium+Web:wght@200;300;400;600;700&display=swap");
  ...
  *::before {
  ...
  body {
    ...
    /* * english-font, 3rd language-font, 한글 폰트 순서로 */
    font-family: "Titillium Web", -apple-system, "Segoe UI", Roboto, Oxygen,
      Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", "Nanum Gothic Coding",
